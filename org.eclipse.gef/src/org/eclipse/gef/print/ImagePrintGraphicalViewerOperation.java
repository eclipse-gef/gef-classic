...
public class ImagePrintGraphicalViewerOperation extends ImagePrintFigureOperation {
	 ...
	 *
	 * @param device The device to print to
	 ...
	 */
	public ImagePrintGraphicalViewerOperation(Device device, GraphicalViewer viewer) {
		super(device);
		this.viewer = viewer;
	...
	/**
	 * @see ImagePrintFigureOperation#preparePrintSource()
	 */
	@Override
	...
	/**
	 * @see ImagePrintFigureOperation#restorePrintSource()
	 */
	@Override
