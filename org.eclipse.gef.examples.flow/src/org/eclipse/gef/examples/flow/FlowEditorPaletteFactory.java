...
public final class FlowEditorPaletteFactory {
	...
	private static PaletteContainer createComponentsDrawer() {
		...
		CombinedTemplateCreationEntry combined = new CombinedTemplateCreationEntry("Activity", //$NON-NLS-1$
				...
				InternalImages.createDescriptor(FlowPlugin.class, "images/gear16.svg"), //$NON-NLS-1$
				InternalImages.createDescriptor(Activity.class, "images/gear24.svg")); //$NON-NLS-1$
		...
		combined = new CombinedTemplateCreationEntry("Sequential Activity", "Create a Sequential Activity", //$NON-NLS-1$ //$NON-NLS-2$
				...
				InternalImages.createDescriptor(FlowPlugin.class, "images/sequence16.svg"), //$NON-NLS-1$
				InternalImages.createDescriptor(FlowPlugin.class, "images/sequence24.svg")); //$NON-NLS-1$
		entries.add(combined);
		...
		combined = new CombinedTemplateCreationEntry("Parallel Activity", "Create a  Parallel Activity", //$NON-NLS-1$ //$NON-NLS-2$
				...
				InternalImages.createDescriptor(FlowPlugin.class, "images/parallel16.svg"), //$NON-NLS-1$
				InternalImages.createDescriptor(FlowPlugin.class, "images/parallel24.svg")); //$NON-NLS-1$
		entries.add(combined);
	...
	private static PaletteContainer createControlGroup(PaletteRoot root) {
		...
		tool = new ConnectionCreationToolEntry("Connection Creation", "Creating connections", null, //$NON-NLS-1$ //$NON-NLS-2$
				InternalImages.createDescriptor(FlowPlugin.class, "images/connection16.svg"), //$NON-NLS-1$
				InternalImages.createDescriptor(FlowPlugin.class, "images/connection24.svg")); //$NON-NLS-1$
		entries.add(tool);
